...
const Food = ({ showAlert }) => {
    return (
        <div className='max-w-7xl mx-auto py-6 sm:px-6 lg:px-8'>
            <div class="bg-white">
                <div class="max-w-2xl mx-auto py-4 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
                    <h2 class="text-2xl font-extrabold tracking-tight text-gray-900">Recommended</h2>
                    <div class="mt-6 grid gap-y-10 gap-x-6 md:grid-col-4 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
